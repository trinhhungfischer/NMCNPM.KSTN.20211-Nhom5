 ...
 * @author Hoang
 */
public class ChoosePeopleCachLy extends javax.swing.JFrame {

    private NhanKhauBean nhanKhauBean;
    private NhanKhauBean nhanKhauBeanTemp;
    private JFrame parentJFrame;
    private final ChoosePeopleCachLyController controller;
     ...
     */
    public ChoosePeopleCachLy(NhanKhauBean nhanKhauBean, JFrame parentJframe) {
        initComponents();
        this.nhanKhauBean = nhanKhauBean;
        this.parentJFrame = parentJframe;
        this.nhanKhauBeanTemp = new NhanKhauBean();
        parentJframe.setEnabled(false);
        controller = new ChoosePeopleCachLyController(this.nhanKhauBeanTemp, searchJtf, selectedJtf, tableJpn, this);
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        this.parentJFrame.setEnabled(true);
        AddNewCachLyJFrame addNewCachLyJFrame = (AddNewCachLyJFrame) this.parentJFrame;
        addNewCachLyJFrame.setDataNhanKhau();
        this.parentJFrame.setEnabled(true);
        dispose();

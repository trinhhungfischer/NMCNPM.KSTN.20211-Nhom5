 ...
 * @author Hai
 */
public class ChoosePeopleThemMoi extends javax.swing.JFrame {
     ...
     */
    public ChoosePeopleThemMoi(NhanKhauBean nhanKhauBean, JFrame parentJframe) {
        initComponents();
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        this.parentJFrame.setEnabled(true);
        ThemThanhVien themThanhVien = (ThemThanhVien)this.parentJFrame;
        themThanhVien.setDataThanhVien();
        dispose();

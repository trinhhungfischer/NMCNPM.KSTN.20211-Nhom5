 ...
 * @author Hoang
 */
public class ChoosePeopleSucKhoe extends javax.swing.JFrame {

    private NhanKhauBean nhanKhauBean;
    private NhanKhauBean nhanKhauBeanTemp;
    private JFrame parentJFrame;
    private final ChoosePeopleSucKhoeController controller;
     ...
     */
    public ChoosePeopleSucKhoe(NhanKhauBean nhanKhauBean, JFrame parentJframe) {
        initComponents();
        this.nhanKhauBean = nhanKhauBean;
        this.parentJFrame = parentJframe;
        this.nhanKhauBeanTemp = new NhanKhauBean();
        parentJframe.setEnabled(false);
        controller = new ChoosePeopleSucKhoeController(this.nhanKhauBeanTemp, searchJtf, selectedJtf, tableJpn, this);
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        this.parentJFrame.setEnabled(true);
        ThemMoiSucKhoeFrame themMoiSucKhoeFrame = (ThemMoiSucKhoeFrame)this.parentJFrame;
        themMoiSucKhoeFrame.setDataNhanKhau();
        dispose();

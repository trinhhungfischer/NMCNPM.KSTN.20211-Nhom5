 ...
 * @author Hai
 */
public class ChoosePeopleCachLyController {
     ...
     * @param tableJPanel 
     */
    public ChoosePeopleCachLyController(NhanKhauBean nhanKhauBean, JTextField searchJtf, JTextField selectedJtf, JPanel tableJPanel, JFrame parenJFrame) {
